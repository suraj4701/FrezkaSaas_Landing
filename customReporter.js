...
class CustomReporter {
    ...
    async onEnd(result) {
        ...
        console.log(`\n--- Test Summary ---`);
        console.log(`Project: Frezka Saas Landing Page`);
    ...
    async sendReportEmail(overallStatus, passedCount, failedCount) {
        ...
        let emailHtmlBody = `
            <p>Dear Team,</p>
            <p>Here is the automated Playwright test report summary for <strong>Frezka Saas Landing Page</strong> as of ${new Date().toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' })}.</p>
            <hr>
            <h2>Test Summary</h2>
